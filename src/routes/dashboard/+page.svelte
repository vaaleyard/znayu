<script lang="ts">
  ...
  const statusPages: StatusPage[] = [
    { name: 'Acme Cloud', slug: 'status.acme.cloud', services: 8, uptime: '99.98%', health: 'Operational' },
    { name: 'Internal Platform', slug: 'platform.internal', services: 12, uptime: '99.94%', health: 'Degraded' }
  ];
...
<main class="dashboard-page">
  <aside class="sidebar" aria-label="Operator navigation">
    <div class="sidebar-top">
      <a class="wordmark" href="/" aria-label="Znayu public status page">znayu</a>
      <span class="console-label">Console</span>
    </div>

    <div class="create-actions">
      <button class="create-button primary" type="button">Create monitor</button>
      <button class="create-button secondary" type="button">Create status page</button>
    </div>
    ...
    <div class="sidebar-bottom">
      <a href="/" class="public-link">View public status <svg aria-hidden="true" viewBox="0 0 16 16"><path d="M4 12 12 4M6 4h6v6" /></svg></a>
      <div class="operator">
    ...
    <div class="dashboard-grid">
      ...
      <section class="panel monitors-panel" id="monitors" aria-labelledby="monitors-title">
        <header class="panel-header">
          ...
          <button type="button" class="text-button">Manage monitors</button>
        </header>
...
<style>
  ...
  .sidebar { display: flex; min-height: 100svh; padding: 22px 14px 16px; flex-direction: column; background: #141821; border-right: 1px solid var(--border); }
  ...
  .create-button { min-height: 38px; border-radius: 5px; font-size: 0.8125rem; font-weight: 620; cursor: pointer; }
  ...
  .sidebar-nav svg, .notification-button svg { width: 16px; height: 16px; fill: none; stroke: currentColor; stroke-linecap: round; stroke-linejoin: round; stroke-width: 1.5; }
  ...
  .dashboard-content { width: min(100%, 1080px); margin: 0 auto; padding: 40px 48px 64px; }
  ...
  .text-button, .panel-link { border: 0; background: transparent; cursor: pointer; }
  ...
  .page-mark { width: 8px; height: 8px; border: 1px solid var(--green); border-radius: 1px; }
  .page-identity { min-width: 0; }
  .page-identity h3, .activity-row h3 { overflow: hidden; font-size: 0.8125rem; font-weight: 600; line-height: 1.4; text-overflow: ellipsis; white-space: nowrap; }
